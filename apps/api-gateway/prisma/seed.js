  ...
  const employees = await Promise.all([
    prisma.employee.upsert({
      ...
      create: {
        ...
        annualSalary: 86000,
        currency: 'USD',
        location: { connect: { id: hcmLocation.id } },
        salaryBand: { connect: { id: seniorBand.id } },
        skills: {
          create: [
    ...
    prisma.employee.upsert({
      ...
      create: {
        ...
        annualSalary: 124000,
        currency: 'USD',
        location: { connect: { id: singaporeLocation.id } },
        salaryBand: { connect: { id: leadBand.id } },
        skills: {
          create: [
    ...
    prisma.employee.upsert({
      ...
      create: {
        ...
        annualSalary: 56000,
        currency: 'USD',
        location: { connect: { id: hanoiLocation.id } },
        salaryBand: { connect: { id: peopleBand.id } },
        skills: {
          create: [
